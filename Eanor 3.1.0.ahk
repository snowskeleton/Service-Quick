...
:O0:;90::customer is covered under 90 day. customer agreed to additional costs via cc
:O0:;otw::advised cx of OTWER limitations
:O0:;otwer::advised cx of OTWER limitations
...
:O0:nsm::no strange smells

:O0:spa::cx requested spanish. informed cx a spanish agent would call back
...
:O0:tpciu::third party called in for update on ticket
